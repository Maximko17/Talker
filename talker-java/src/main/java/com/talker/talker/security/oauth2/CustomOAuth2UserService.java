...
import com.talker.talker.domain.AuthProvider;
import com.talker.talker.domain.User;
import com.talker.talker.exceptions.OAuth2AuthenticationProcessingException;
import com.talker.talker.repository.UserRepository;
import com.talker.talker.security.UserPrincipal;
import com.talker.talker.security.oauth2.user.OAuth2UserInfo;
import com.talker.talker.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        user.setTotalFollowing(0);
        user.setTotalFollowers(0);
        user.setLogin_date(new Date().getTime());
        user.setEmail(oAuth2UserInfo.getEmail());
        user.setName(oAuth2UserInfo.getName());
        user.setPhoto(oAuth2UserInfo.getImageUrl());
        user.setProfileTheme("#6a0bff");
